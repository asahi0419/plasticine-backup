...
const LegendWidthResizer = ({ map, configs, onChange }) => {
  ...
  const onDrag = (e) => {
    const legend = document.getElementById('view-map-legend-menu');
    const content = document.querySelector('.view-map-content');
    const controls = document.querySelector('.view-map-controls');
  ...
  return (
    <LegendWidthResizerStyled
      className="view-map-legend-width-resizer"
      draggable="true"
