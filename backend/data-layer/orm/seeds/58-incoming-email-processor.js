export default {
  name: 'Incoming emails processing',
  plural: 'Incoming emails processing',
  alias: 'incoming_emails_processing',
  type: 'core',
  template: 'base',
  ...
  layouts: [
    {
      ...
      type: 'grid',
      options: {
        columns: ['id', 'name', 'active', 'created_at', 'created_by', 'updated_at', 'updated_by'],
        columns_options: {},
        sort_order: [
