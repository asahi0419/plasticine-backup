...
const PDFCanvas = require("./pdfcanvas.js");
const PDFUnit = require("./pdfunit.js");
const PDFField = require("./pdffield.js");
const PDFAnno = require("./pdfanno.js");
const Image = require("./pdfimage.js");    
const PDFFont = require("./pdffont.js");
const PTIXmlParser = require("./ptixmlinject.js");

const { pkInfo, _PARSER_SIG } = require("../pkinfo.js");
...
module.exports = class PDFJSClass extends EventEmitter {
    pdfDocument = null;
    pages = null;
